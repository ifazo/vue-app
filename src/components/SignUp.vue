      ...
      <div class="flex w-full flex-col md:w-1/2">
        ...
        >
          ...
          <p class="mt-6 text-center font-medium md:text-left">
            ...
            <RouterLink to="/signin" class="whitespace-nowrap font-semibold text-blue-700"
              >Signin here</RouterLink
            >
          </p>
          <button
          ...
          >
            <img class="mr-2 h-5" src="/images/beep-cover.png" alt="" /> Get started with
            Google
          </button>
          ...
          <form class="flex flex-col items-stretch pt-3 md:pt-8">
            ...
            <div class="mb-4 flex flex-col pt-4">
              ...
              >
                <input
                  ...
                  id="confirm-password"
                  class="w-full flex-shrink appearance-none border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none"
                  placeholder="Retype Password (minimum 8 characters)"
                />
              </div>
            </div>
            ...
            <div class="block">
              ...
              <label class="inline-block" for="remember-me">
                I agree to the <a class="underline" href="#">Terms and Conditions</a></label
              >
            </div>
            <button
...
//   const { error } = await supabase.auth.api.updateUser(password.value);
//   if (error) {
//     console.log(error);
//   }
// };
